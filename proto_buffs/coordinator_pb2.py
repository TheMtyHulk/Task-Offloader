...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TASKRESPONSE']._serialized_end=129
  _globals['_COORDINATORSERVICE']._serialized_start=131
  _globals['_COORDINATORSERVICE']._serialized_end=232
