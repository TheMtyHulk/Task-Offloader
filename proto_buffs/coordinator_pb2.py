...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TASKRESPONSE']._serialized_end=133
  _globals['_COORDINATORSERVICE']._serialized_start=135
  _globals['_COORDINATORSERVICE']._serialized_end=236
